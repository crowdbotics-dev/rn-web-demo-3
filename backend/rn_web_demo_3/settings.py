"""
Django settings for rn_web_demo_3 project.
...
ROOT_URLCONF = 'rn_web_demo_3.urls'
...
WSGI_APPLICATION = 'rn_web_demo_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rn_web_demo_3 API",
    "DESCRIPTION": "API documentation for rn_web_demo_3 App",
    "VERSION": "v1",
}
